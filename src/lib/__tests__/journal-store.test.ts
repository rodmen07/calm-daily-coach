...
// override coverage, adapted to the journal's read/write pair. The four
// scenarios come straight from docs/design/JOURNAL_FIRESTORE_SYNC.md's
// done-when: unconfigured or signed-out stays local; configured and
// signed-in resolves firestore; a thrown Firestore error falls back to
// local; explicit local override always wins regardless of config.
